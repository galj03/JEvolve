...
import com.utils.AnalyzingJavaParser;
...
public class ConcreteJavaParser {
    public ConcreteJavaParser() {
...
//            return  (Module)mod;
    ...
    //TODO: implement when working with holes
    private CompilationUnit prepareHoles(CompilationUnit module) {
        ParentUpdater pUpdater = new ParentUpdater();
...
//        ANTLRStringStream antlrSting = new ANTLRStringStream(code);
        ...
        AnalyzingJavaParser p = new AnalyzingJavaParser(
                JavaASTUtil.convertStreamToString(stream), "<CustomFillerUnitName>");
        return prepareHoles(p.parse());
    }
...
//    }
    ...
    //TODO: implement when introducing holes
//    class PyHoleVisitorAndRepair extends ASTBaseVisitor {
////        @Override
...
//    }
    ...
    //TODO: this should work as it is, the others were for setting child's parents (the visitor should set them all anyway)
    class ParentUpdater extends ASTBaseVisitor {
        @Override
        public void preVisit(ASTNode node) {
