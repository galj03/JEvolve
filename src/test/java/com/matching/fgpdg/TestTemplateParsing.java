...
public class TestTemplateParsing {
    ...
    void testPDG1() throws Exception {
        String code = """
                ...
                [[$15]]([[$1]])
                """;
        CompilationUnit mod = parseJava(code);
        System.out.println(mod.toString());
//        PyErrorVisitor error = new PyErrorVisitor();
//        error.visit(mod);
//        Assertions.assertEquals(0, error.getError());
//        Assertions.assertEquals(code.split("\\$").length - 1, error.getHoles());
    }
    ...
    void testPDG2() throws Exception {
        ...
        CompilationUnit mod = parseJava(code);
        System.out.println(mod.toString());
        Guards guard = new Guards(code, mod);
//        PyErrorVisitor error = new PyErrorVisitor();
//        error.visit(mod);
//        Assertions.assertEquals(0, error.getError());
//        Assertions.assertEquals(code.split("\\$").length - 1, error.getHoles());
...
//        Assertions.assertEquals(code.split("\\$").length - 1, error.getHoles());
    ...
    public static CompilationUnit parseJava(String code) throws IOException {
...
//class PyErrorVisitor extends ASTBaseVisitor {
//    private int error = 0;
//    private int holes = 0;
//
//    public int getError() {
